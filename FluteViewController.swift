...
class FluteViewController: UIViewController, UITableViewDelegate, UITableViewDataSource
{
...
//        let fileUrl = url.appendingPathComponent("updatingDateFolder").appendingPathComponent("fluteDate.txt")
...
//        }
    ...
    func configureSongs()
    {
        songs.append(Song(name: "Flute - Track 1",
                          albumName: "Flute Music",
                          artistName: "Mindful Music",
                          imageName: "flutePic",
                          trackname: "fluteCalm"))
        
        songs.append(Song(name: "Flute - Track 2",
                          albumName: "Flute Music",
                          artistName: "Mindful Music",
                          imageName: "flutePic",
                          trackname: "flute2"))
        
        songs.append(Song(name: "Flute - Track 3",
                          albumName: "Flute Music",
                          artistName: "Mindful Music",
                          imageName: "flutePic",
                          trackname: "flute3"))
        
        songs.append(Song(name: "Flute - Track 4",
                          albumName: "Flute Music",
                          artistName: "Mindful Music",
                          imageName: "flutePic",
                          trackname: "flute4"))
        
        songs.append(Song(name: "Flute - Track 5",
                          albumName: "Flute Music",
                          artistName: "Mindful Music",
                          imageName: "flutePic",
                          trackname: "flute5"))
    ...
    {
        let cell = tableView.dequeueReusableCell(withIdentifier: "CellId15") as! UITableViewCell
    ...
    @objc func didChangeSwitch(_ sender: UISwitch!)
    {
        ...
        {
            let urlString = Bundle.main.path(forResource: "fluteCalm", ofType: "mp3")
            do
            {
        ...
        {
            let urlString = Bundle.main.path(forResource: "flute2", ofType: "mp3")
            do
            {
                try AVAudioSession.sharedInstance().setMode(.default)
                try AVAudioSession.sharedInstance().setActive(true, options: .notifyOthersOnDeactivation)
        ...
        {
            let urlString = Bundle.main.path(forResource: "flute3", ofType: "mp3")
            do
            {
                try AVAudioSession.sharedInstance().setMode(.default)
                try AVAudioSession.sharedInstance().setActive(true, options: .notifyOthersOnDeactivation)
        ...
        {
            let urlString = Bundle.main.path(forResource: "flute4", ofType: "mp3")
            do
            {
                try AVAudioSession.sharedInstance().setMode(.default)
                try AVAudioSession.sharedInstance().setActive(true, options: .notifyOthersOnDeactivation)
        ...
        {
            let urlString = Bundle.main.path(forResource: "flute5", ofType: "mp3")
            do
            {
                try AVAudioSession.sharedInstance().setMode(.default)
                try AVAudioSession.sharedInstance().setActive(true, options: .notifyOthersOnDeactivation)
