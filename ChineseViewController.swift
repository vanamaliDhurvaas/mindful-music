...
class ChineseViewController: UIViewController, UITableViewDelegate, UITableViewDataSource
{
...
//        let fileUrl = url.appendingPathComponent("updatingDateFolder").appendingPathComponent("chinaDate.txt")
...
//        }
    ...
    {
        let cell = tableView.dequeueReusableCell(withIdentifier: "CellId5") as! UITableViewCell
