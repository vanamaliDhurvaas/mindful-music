...
class RockViewController: UIViewController, UITableViewDelegate, UITableViewDataSource
{
...
//        let fileUrl = url.appendingPathComponent("updatingDateFolder").appendingPathComponent("rockDate.txt")
...
//        }
    ...
    func configureSongs()
    {
        songs.append(Song(name: "Rock Track One (Prod. Ryini Beats)",
                          albumName: "Rock Music",
                          artistName: "Mindful Music",
                          imageName: "rockPic",
                          trackname: "rock1"))
        
        songs.append(Song(name: "Rock Track Two (Prod. JB in Reason)",
                          albumName: "Rock Music",
                          artistName: "Mindful Music",
                          imageName: "rockPic",
                          trackname: "rock2"))
        
        songs.append(Song(name: "Rock Track Three (Prod. ERLAX)",
                          albumName: "Rock Music",
                          artistName: "Mindful Music",
                          imageName: "rockPic",
                          trackname: "rock3"))
        
        songs.append(Song(name: "Rock Track Four (Prod. Dutch Revz)",
                          albumName: "Rock Music",
                          artistName: "Mindful Music",
                          imageName: "rockPic",
                          trackname: "rock4"))
        
        songs.append(Song(name: "Rock Track Five (Prod. GAXILLIC)",
                          albumName: "Rock Music",
                          artistName: "Mindful Music",
                          imageName: "rockPic",
                          trackname: "rock5"))
    ...
    {
        let cell = tableView.dequeueReusableCell(withIdentifier: "CellId17") as! UITableViewCell
    ...
    @objc func didChangeSwitch(_ sender: UISwitch!)
    {
        ...
        {
            let urlString = Bundle.main.path(forResource: "rock1", ofType: "mp3")
            do
            {
        ...
        {
            let urlString = Bundle.main.path(forResource: "rock2", ofType: "mp3")
            do
            {
                try AVAudioSession.sharedInstance().setMode(.default)
                try AVAudioSession.sharedInstance().setActive(true, options: .notifyOthersOnDeactivation)
        ...
        {
            let urlString = Bundle.main.path(forResource: "rock3", ofType: "mp3")
            do
            {
                try AVAudioSession.sharedInstance().setMode(.default)
                try AVAudioSession.sharedInstance().setActive(true, options: .notifyOthersOnDeactivation)
        ...
        {
            let urlString = Bundle.main.path(forResource: "rock4", ofType: "mp3")
            do
            {
                try AVAudioSession.sharedInstance().setMode(.default)
                try AVAudioSession.sharedInstance().setActive(true, options: .notifyOthersOnDeactivation)
        ...
        {
            let urlString = Bundle.main.path(forResource: "rock5", ofType: "mp3")
            do
            {
                try AVAudioSession.sharedInstance().setMode(.default)
                try AVAudioSession.sharedInstance().setActive(true, options: .notifyOthersOnDeactivation)
