//
//  RapViewController.swift
//  MusicApp
//
//  Created by Vanamali Dhurvaas on 7/16/22.
//

import UIKit
import AVFAudio

class RapViewController: UIViewController, UITableViewDelegate, UITableViewDataSource
{
    ...
    override func viewDidLoad()
    {
        ...
        var value = UserDefaults.standard.integer(forKey: "hiddenMinData4")
        ...
        var value2 = UserDefaults.standard.integer(forKey: "hiddenSecData4")
        ...
        var value3 = UserDefaults.standard.integer(forKey: "hiddenHourData4")
        if value3 != nil
        {
            hiddenHours = value3
...
//        let fileUrl = url.appendingPathComponent("updatingDateFolder").appendingPathComponent("rapDate.txt")
...
//                           attributes: [FileAttributeKey.creationDate: Date()])
        ...
        let fileUrl = folderUrl.appendingPathComponent("rockDate.txt")
        do {
...
//        }
    ...
    func configureSongs()
    {
        songs.append(Song(name: "Hip-Hop/Rap Track One (Prod. Chris Falcone)",
                          albumName: "Hip-Hop/Rap Music",
                          artistName: "Mindful Music",
                          imageName: "rapPic",
                          trackname: "rap1"))
        
        songs.append(Song(name: "Hip-Hop/Rap Track Two (Prod. KATANO BEATS)",
                          albumName: "Hip-Hop/Rap Music",
                          artistName: "Mindful Music",
                          imageName: "rapPic",
                          trackname: "rap2"))
        
        songs.append(Song(name: "Hip-Hop/Rap Track Three (Prod.  Rajaste)",
                          albumName: "Hip-Hop/Rap Music",
                          artistName: "Mindful Music",
                          imageName: "rapPic",
                          trackname: "rap3"))
        
        songs.append(Song(name: "Hip-Hop/Rap Track Four (Prod. Emporio Beats)",
                          albumName: "Hip-Hop/Rap Music",
                          artistName: "Mindful Music",
                          imageName: "rapPic",
                          trackname: "rap4"))
        
        songs.append(Song(name: "Hip-Hop/Rap Track Five (Prod. Mario)",
                          albumName: "Hip-Hop/Rap Music",
                          artistName: "Mindful Music",
                          imageName: "rapPic",
                          trackname: "rap5"))
    ...
    {
        let cell = tableView.dequeueReusableCell(withIdentifier: "CellId19") as! UITableViewCell
    ...
    @objc func didChangeSwitch(_ sender: UISwitch!)
    {
        ...
        {
            let urlString = Bundle.main.path(forResource: "rap1", ofType: "mp3")
            do
            {
        ...
        {
            let urlString = Bundle.main.path(forResource: "rap2", ofType: "mp3")
            do
            {
                try AVAudioSession.sharedInstance().setMode(.default)
                try AVAudioSession.sharedInstance().setActive(true, options: .notifyOthersOnDeactivation)
        ...
        {
            let urlString = Bundle.main.path(forResource: "rap3", ofType: "mp3")
            do
            {
                try AVAudioSession.sharedInstance().setMode(.default)
                try AVAudioSession.sharedInstance().setActive(true, options: .notifyOthersOnDeactivation)
        ...
        {
            let urlString = Bundle.main.path(forResource: "rap4", ofType: "mp3")
            do
            {
                try AVAudioSession.sharedInstance().setMode(.default)
                try AVAudioSession.sharedInstance().setActive(true, options: .notifyOthersOnDeactivation)
        ...
        {
            let urlString = Bundle.main.path(forResource: "rap5", ofType: "mp3")
            do
            {
                try AVAudioSession.sharedInstance().setMode(.default)
                try AVAudioSession.sharedInstance().setActive(true, options: .notifyOthersOnDeactivation)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?)
    {
        ...
        if (segue.identifier == "finishSegue")
        {
            ...
            else
            {
                ...
                player7?.stop()
                player8?.stop()
                let word7 = hiddenMinutesLabel.text!
                let word8 = hiddenHoursLabel.text!
                let nvc = segue.destination as! HomeViewController
                nvc.passedWord7 = word7
                nvc.passedWord8 = word8
                UserDefaults.standard.set(hiddenMinutesLabel.text, forKey: "myExMinData")
                UserDefaults.standard.set(hiddenSecondsLabel.text, forKey: "myExSecData")
                UserDefaults.standard.set(hiddenHoursLabel.text, forKey: "myExHourData")
                
                UserDefaults.standard.set(hiddenHours, forKey: "hiddenHourData4")
                UserDefaults.standard.set(hiddenMinutes, forKey: "hiddenMinData4")
                UserDefaults.standard.set(hiddenSeconds, forKey: "hiddenSecData4")
                timer2.invalidate()
            }
