//
//  AnimalSoundsViewController.swift
//  MusicApp
//
...
class AnimalSoundsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource
{
...
//        let fileUrl = url.appendingPathComponent("updatingDateFolder").appendingPathComponent("animalDate.txt")
...
//        }
    ...
    {
        let cell = tableView.dequeueReusableCell(withIdentifier: "CellId9") as! UITableViewCell
