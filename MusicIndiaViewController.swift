//
//  MusicIndiaViewController.swift
//  MusicApp
//
...
class MusicIndiaViewController: UIViewController, UITableViewDelegate, UITableViewDataSource
{
...
//        let fileUrl = url.appendingPathComponent("updatingDateFolder").appendingPathComponent("musicIndiaDate.txt")
...
//        }
    ...
    func configureSongs()
    {
        songs.append(Song(name: "Vibrant Tune",
                          albumName: "Indian Music",
                          artistName: "Mindful Music",
                          imageName: "musicIndiaPic",
                          trackname: "indiaWeds"))
        
        songs.append(Song(name: "Santoor Instrumental",
                          albumName: "Indian Music",
                          artistName: "Mindful Music",
                          imageName: "musicIndiaPic",
                          trackname: "indiaSantoor"))
        
        songs.append(Song(name: "Swarmandal Instrumental",
                          albumName: "Indian Music",
                          artistName: "Mindful Music",
                          imageName: "musicIndiaPic",
                          trackname: "indiaSwarmandal"))
        
        songs.append(Song(name: "Calm Sounds of India",
                          albumName: "Indian Music",
                          artistName: "Mindful Music",
                          imageName: "musicIndiaPic",
                          trackname: "indiaCalm"))
        
        songs.append(Song(name: "Traditional Indian Music",
                          albumName: "Indian Music",
                          artistName: "Mindful Music",
                          imageName: "musicIndiaPic",
                          trackname: "indiaTraditional"))
    }
    ...
    {
        let cell = tableView.dequeueReusableCell(withIdentifier: "CellId13") as! UITableViewCell
    ...
    @objc func didChangeSwitch(_ sender: UISwitch!)
    {
        ...
        {
            let urlString = Bundle.main.path(forResource: "indiaWeds", ofType: "mp3")
            do
            {
        ...
        {
            let urlString = Bundle.main.path(forResource: "indiaSantoor", ofType: "mp3")
            do
            {
                try AVAudioSession.sharedInstance().setMode(.default)
                try AVAudioSession.sharedInstance().setActive(true, options: .notifyOthersOnDeactivation)
        ...
        {
            let urlString = Bundle.main.path(forResource: "indiaSwarmandal", ofType: "mp3")
            do
            {
                try AVAudioSession.sharedInstance().setMode(.default)
                try AVAudioSession.sharedInstance().setActive(true, options: .notifyOthersOnDeactivation)
        ...
        {
            let urlString = Bundle.main.path(forResource: "indiaCalm", ofType: "mp3")
            do
            {
                try AVAudioSession.sharedInstance().setMode(.default)
                try AVAudioSession.sharedInstance().setActive(true, options: .notifyOthersOnDeactivation)
        ...
        {
            let urlString = Bundle.main.path(forResource: "indiaTraditional", ofType: "mp3")
            do
            {
                try AVAudioSession.sharedInstance().setMode(.default)
                try AVAudioSession.sharedInstance().setActive(true, options: .notifyOthersOnDeactivation)
