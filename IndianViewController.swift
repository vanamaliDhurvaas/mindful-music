...
//  MusicApp
//
//  Created by Vanamali Dhurvaas on 7/13/22.
//

import UIKit
import AVFAudio

class IndianViewController: UIViewController, UITableViewDelegate, UITableViewDataSource
{
...
//        }
    ...
    {
        let cell = tableView.dequeueReusableCell(withIdentifier: "CellId4") as! UITableViewCell
