...
class JapaneseViewController: UIViewController, UITableViewDelegate, UITableViewDataSource
{
...
//        let fileUrl = url.appendingPathComponent("updatingDateFolder").appendingPathComponent("japanDate.txt")
...
//        }
    ...
    func configureSongs()
    {
        songs.append(Song(name: "Koto Music",
                          albumName: "Japanese Sounds",
                          artistName: "Mindful Music",
                          imageName: "japanPic",
                          trackname: "koto"))
        
        songs.append(Song(name: "Music of Edo Period",
                          albumName: "Japanese Sounds",
                          artistName: "Mindful Music",
                          imageName: "japanPic",
                          trackname: "edo"))
        
        songs.append(Song(name: "Shakuhachi Flute",
                          albumName: "Japanese Sounds",
                          artistName: "Mindful Music",
                          imageName: "japanPic",
                          trackname: "shakuhachi"))
        
        songs.append(Song(name: "Traditional Japanese Music",
                          albumName: "Japanese Sounds",
                          artistName: "Mindful Music",
                          imageName: "japanPic",
                          trackname: "trad"))
        
        songs.append(Song(name: "Upbeat Japanese Music",
                          albumName: "Japanese Sounds",
                          artistName: "Mindful Music",
                          imageName: "japanPic",
                          trackname: "upbeat"))
    ...
    {
        let cell = tableView.dequeueReusableCell(withIdentifier: "CellId10") as! UITableViewCell
    ...
    @objc func didChangeSwitch(_ sender: UISwitch!)
    {
        ...
        {
            let urlString = Bundle.main.path(forResource: "koto", ofType: "mp3")
            do
            {
        ...
        {
            let urlString = Bundle.main.path(forResource: "edo", ofType: "mp3")
            do
            {
                try AVAudioSession.sharedInstance().setMode(.default)
                try AVAudioSession.sharedInstance().setActive(true, options: .notifyOthersOnDeactivation)
        ...
        {
            let urlString = Bundle.main.path(forResource: "shakuhachi", ofType: "mp3")
            do
            {
                try AVAudioSession.sharedInstance().setMode(.default)
                try AVAudioSession.sharedInstance().setActive(true, options: .notifyOthersOnDeactivation)
        ...
        {
            let urlString = Bundle.main.path(forResource: "trad", ofType: "mp3")
            do
            {
                try AVAudioSession.sharedInstance().setMode(.default)
                try AVAudioSession.sharedInstance().setActive(true, options: .notifyOthersOnDeactivation)
        ...
        {
            let urlString = Bundle.main.path(forResource: "upbeat", ofType: "mp3")
            do
            {
                try AVAudioSession.sharedInstance().setMode(.default)
                try AVAudioSession.sharedInstance().setActive(true, options: .notifyOthersOnDeactivation)
