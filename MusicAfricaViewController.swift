//
//  MusicAfricaViewController.swift
//  MusicApp
//
...
class MusicAfricaViewController: UIViewController, UITableViewDelegate, UITableViewDataSource
{
...
//        let fileUrl = url.appendingPathComponent("updatingDateFolder").appendingPathComponent("musicAfricaDate.txt")
...
//        }
    ...
    func configureSongs()
    {
        songs.append(Song(name: "African Music One",
                          albumName: "African Music",
                          artistName: "Mindful Music",
                          imageName: "africanPic",
                          trackname: "africa1"))
        
        songs.append(Song(name: "African Music Two",
                          albumName: "African Music",
                          artistName: "Mindful Music",
                          imageName: "africanPic",
                          trackname: "africa2"))
        
        songs.append(Song(name: "African Music Three",
                          albumName: "African Music",
                          artistName: "Mindful Music",
                          imageName: "africanPic",
                          trackname: "africa3"))
        
        songs.append(Song(name: "African Music Four",
                          albumName: "African Music",
                          artistName: "Mindful Music",
                          imageName: "africanPic",
                          trackname: "africa4"))
        
        songs.append(Song(name: "African Music Five",
                          albumName: "African Music",
                          artistName: "Mindful Music",
                          imageName: "africanPic",
    ...
    {
        let cell = tableView.dequeueReusableCell(withIdentifier: "CellId20") as! UITableViewCell
    ...
    @objc func didChangeSwitch(_ sender: UISwitch!)
    {
        ...
        {
            let urlString = Bundle.main.path(forResource: "africa1", ofType: "mp3")
            do
            {
        ...
        {
            let urlString = Bundle.main.path(forResource: "africa2", ofType: "mp3")
            do
            {
                try AVAudioSession.sharedInstance().setMode(.default)
                try AVAudioSession.sharedInstance().setActive(true, options: .notifyOthersOnDeactivation)
        ...
        {
            let urlString = Bundle.main.path(forResource: "africa3", ofType: "mp3")
            do
            {
                try AVAudioSession.sharedInstance().setMode(.default)
                try AVAudioSession.sharedInstance().setActive(true, options: .notifyOthersOnDeactivation)
        ...
        {
            let urlString = Bundle.main.path(forResource: "africa4", ofType: "mp3")
            do
            {
                try AVAudioSession.sharedInstance().setMode(.default)
                try AVAudioSession.sharedInstance().setActive(true, options: .notifyOthersOnDeactivation)
