...
//        let fileUrl = url.appendingPathComponent("updatingDateFolder").appendingPathComponent("myMusicDate.txt")
...
//        }
    ...
    func configureSongs()
    {
        songs.append(Song(name: "Far Away",
                          albumName: "My Music",
                          artistName: "Mindful Music",
                          imageName: "myPic",
                          trackname: "farAway"))
        
        songs.append(Song(name: "Stay With Me",
                          albumName: "My Music",
                          artistName: "Mindful Music",
                          imageName: "myPic",
                          trackname: "stayWithMe"))
        
        songs.append(Song(name: "Day Dreamin'",
                          albumName: "My Music",
                          artistName: "Mindful Music",
                          imageName: "myPic",
                          trackname: "dayDreamin"))
        
        songs.append(Song(name: "Under Water",
                          albumName: "My Music",
                          artistName: "Mindful Music",
                          imageName: "myPic",
                          trackname: "underWater"))
        
        songs.append(Song(name: "Surrounded",
                          albumName: "My Music",
                          artistName: "Mindful Music",
                          imageName: "myPic",
                          trackname: "surrounded"))
        
        songs.append(Song(name: "Something New",
                          albumName: "My Music",
                          artistName: "Mindful Music",
                          imageName: "myPic",
                          trackname: "somethingNew"))
    }
    ...
    {
        let cell = tableView.dequeueReusableCell(withIdentifier: "CellId16") as! UITableViewCell
    ...
    @objc func didChangeSwitch(_ sender: UISwitch!)
    {
        ...
        {
            let urlString = Bundle.main.path(forResource: "farAway", ofType: "mp3")
            do
            {
        ...
        {
            let urlString = Bundle.main.path(forResource: "stayWithMe", ofType: "mp3")
            do
            {
                try AVAudioSession.sharedInstance().setMode(.default)
                try AVAudioSession.sharedInstance().setActive(true, options: .notifyOthersOnDeactivation)
        ...
        {
            let urlString = Bundle.main.path(forResource: "dayDreamin", ofType: "mp3")
            do
            {
                try AVAudioSession.sharedInstance().setMode(.default)
                try AVAudioSession.sharedInstance().setActive(true, options: .notifyOthersOnDeactivation)
        ...
        {
            let urlString = Bundle.main.path(forResource: "underWater", ofType: "mp3")
            do
            {
                try AVAudioSession.sharedInstance().setMode(.default)
                try AVAudioSession.sharedInstance().setActive(true, options: .notifyOthersOnDeactivation)
        ...
        {
            let urlString = Bundle.main.path(forResource: "surrounded", ofType: "mp3")
            do
            {
                try AVAudioSession.sharedInstance().setMode(.default)
                try AVAudioSession.sharedInstance().setActive(true, options: .notifyOthersOnDeactivation)
        ...
        {
            let urlString = Bundle.main.path(forResource: "somethingNew", ofType: "mp3")
            do
            {
                try AVAudioSession.sharedInstance().setMode(.default)
                try AVAudioSession.sharedInstance().setActive(true, options: .notifyOthersOnDeactivation)
