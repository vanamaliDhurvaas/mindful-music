...
class GuitarViewController: UIViewController, UITableViewDelegate, UITableViewDataSource
{
...
//        let fileUrl = url.appendingPathComponent("updatingDateFolder").appendingPathComponent("guitarDate.txt")
...
//        }
    ...
    func configureSongs()
    {
        songs.append(Song(name: "Guitar - Track One",
                          albumName: "Guitar Sounds",
                          artistName: "Mindful Music",
                          imageName: "guitarPic",
                          trackname: "guitar1"))
        
        songs.append(Song(name: "Guitar and Piano - Track Two",
                          albumName: "Guitar Sounds",
                          artistName: "Mindful Music",
                          imageName: "guitarPic",
                          trackname: "guitar2"))
        
        songs.append(Song(name: "Guitar - Track Three",
                          albumName: "Guitar Sounds",
                          artistName: "Mindful Music",
                          imageName: "guitarPic",
                          trackname: "guitar3"))
        
        songs.append(Song(name: "Guitar - Track Four",
                          albumName: "Guitar Sounds",
                          artistName: "Mindful Music",
                          imageName: "guitarPic",
                          trackname: "guitar4"))
        
        songs.append(Song(name: "Spanish Guitar - Track Five",
                          albumName: "Guitar Sounds",
                          artistName: "Mindful Music",
                          imageName: "guitarPic",
                          trackname: "guitar5"))
    ...
    {
        let cell = tableView.dequeueReusableCell(withIdentifier: "CellId14") as! UITableViewCell
    ...
    @objc func didChangeSwitch(_ sender: UISwitch!)
    {
        ...
        {
            let urlString = Bundle.main.path(forResource: "guitar1", ofType: "mp3")
            do
            {
        ...
        {
            let urlString = Bundle.main.path(forResource: "guitar2", ofType: "mp3")
            do
            {
                try AVAudioSession.sharedInstance().setMode(.default)
                try AVAudioSession.sharedInstance().setActive(true, options: .notifyOthersOnDeactivation)
        ...
        {
            let urlString = Bundle.main.path(forResource: "guitar3", ofType: "mp3")
            do
            {
                try AVAudioSession.sharedInstance().setMode(.default)
                try AVAudioSession.sharedInstance().setActive(true, options: .notifyOthersOnDeactivation)
        ...
        {
            let urlString = Bundle.main.path(forResource: "guitar4", ofType: "mp3")
            do
            {
                try AVAudioSession.sharedInstance().setMode(.default)
                try AVAudioSession.sharedInstance().setActive(true, options: .notifyOthersOnDeactivation)
        ...
        {
            let urlString = Bundle.main.path(forResource: "guitar5", ofType: "mp3")
            do
            {
                try AVAudioSession.sharedInstance().setMode(.default)
                try AVAudioSession.sharedInstance().setActive(true, options: .notifyOthersOnDeactivation)
