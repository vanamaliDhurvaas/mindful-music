...
class R_BViewController: UIViewController, UITableViewDelegate, UITableViewDataSource
{
...
//        let fileUrl = url.appendingPathComponent("updatingDateFolder").appendingPathComponent("rAndBDate.txt")
...
//        }
    ...
    func configureSongs()
    {
        songs.append(Song(name: "R&B Track One (Prod. Saint Luca)",
                          albumName: "R&B Music",
                          artistName: "Mindful Music",
                          imageName: "r&bPic",
                          trackname: "r&b1"))
        
        songs.append(Song(name: "R&B Track Two (Prod. Gheeny!)",
                          albumName: "R&B Music",
                          artistName: "Mindful Music",
                          imageName: "r&bPic",
                          trackname: "r&b2"))
        
        songs.append(Song(name: "R&B Track Three (Prod. R-ASH x KarnBeats)",
                          albumName: "R&B Music",
                          artistName: "Mindful Music",
                          imageName: "r&bPic",
                          trackname: "r&b3"))
        
        songs.append(Song(name: "R&B Track Four (Prod. Mistar Beats)",
                          albumName: "R&B Music",
                          artistName: "Mindful Music",
                          imageName: "r&bPic",
                          trackname: "r&b4"))
        
        songs.append(Song(name: "R&B Track Five (Prod. Melodic Lee)",
                          albumName: "R&B Music",
                          artistName: "Mindful Music",
                          imageName: "r&bPic",
                          trackname: "r&b5"))
    ...
    {
        let cell = tableView.dequeueReusableCell(withIdentifier: "CellId18") as! UITableViewCell
    ...
    @objc func didChangeSwitch(_ sender: UISwitch!)
    {
        ...
        {
            let urlString = Bundle.main.path(forResource: "r&b1", ofType: "mp3")
            do
            {
        ...
        {
            let urlString = Bundle.main.path(forResource: "r&b2", ofType: "mp3")
            do
            {
                try AVAudioSession.sharedInstance().setMode(.default)
                try AVAudioSession.sharedInstance().setActive(true, options: .notifyOthersOnDeactivation)
        ...
        {
            let urlString = Bundle.main.path(forResource: "r&b3", ofType: "mp3")
            do
            {
                try AVAudioSession.sharedInstance().setMode(.default)
                try AVAudioSession.sharedInstance().setActive(true, options: .notifyOthersOnDeactivation)
        ...
        {
            let urlString = Bundle.main.path(forResource: "r&b4", ofType: "mp3")
            do
            {
                try AVAudioSession.sharedInstance().setMode(.default)
                try AVAudioSession.sharedInstance().setActive(true, options: .notifyOthersOnDeactivation)
        ...
        {
            let urlString = Bundle.main.path(forResource: "r&b5", ofType: "mp3")
            do
            {
                try AVAudioSession.sharedInstance().setMode(.default)
                try AVAudioSession.sharedInstance().setActive(true, options: .notifyOthersOnDeactivation)
