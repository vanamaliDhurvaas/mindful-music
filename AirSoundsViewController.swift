...
class AirSoundsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource
{
...
//        let fileUrl = url.appendingPathComponent("updatingDateFolder").appendingPathComponent("airDate.txt")
...
//        }
    ...
    func configureSongs()
    {
        songs.append(Song(name: "Blizzard",
                          albumName: "Air Sounds",
                          artistName: "Mindful Music",
                          imageName: "airPic",
                          trackname: "blizzard"))
        
        songs.append(Song(name: "Wind Chimes",
                          albumName: "Air Sounds",
                          artistName: "Mindful Music",
                          imageName: "airPic",
                          trackname: "windChimes"))
        
        songs.append(Song(name: "Light Snowfall",
                          albumName: "Air Sounds",
                          artistName: "Mindful Music",
                          imageName: "airPic",
                          trackname: "snowfall"))
        
        songs.append(Song(name: "Brown Noise",
                          albumName: "Air Sounds",
                          artistName: "Mindful Music",
                          imageName: "airPic",
                          trackname: "brownNoise"))
        
        songs.append(Song(name: "White Noise",
                          albumName: "Air Sounds",
                          artistName: "Mindful Music",
                          imageName: "airPic",
                          trackname: "whiteNoise"))
    }
    ...
    {
        let cell = tableView.dequeueReusableCell(withIdentifier: "CellId8") as! UITableViewCell
    ...
    @objc func didChangeSwitch(_ sender: UISwitch!)
    {
        ...
        {
            let urlString = Bundle.main.path(forResource: "blizzard", ofType: "mp3")
            do
            {
        ...
        {
            let urlString = Bundle.main.path(forResource: "windChimes", ofType: "mp3")
            do
            {
                try AVAudioSession.sharedInstance().setMode(.default)
                try AVAudioSession.sharedInstance().setActive(true, options: .notifyOthersOnDeactivation)
        ...
        {
            let urlString = Bundle.main.path(forResource: "snowfall", ofType: "mp3")
            do
            {
                try AVAudioSession.sharedInstance().setMode(.default)
                try AVAudioSession.sharedInstance().setActive(true, options: .notifyOthersOnDeactivation)
        ...
        {
            let urlString = Bundle.main.path(forResource: "brownNoise", ofType: "mp3")
            do
            {
                try AVAudioSession.sharedInstance().setMode(.default)
                try AVAudioSession.sharedInstance().setActive(true, options: .notifyOthersOnDeactivation)
        ...
        {
            let urlString = Bundle.main.path(forResource: "whiteNoise", ofType: "mp3")
            do
            {
                try AVAudioSession.sharedInstance().setMode(.default)
                try AVAudioSession.sharedInstance().setActive(true, options: .notifyOthersOnDeactivation)
