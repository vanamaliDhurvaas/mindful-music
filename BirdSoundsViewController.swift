//
//  BirdSoundsViewController.swift
//  MusicApp
//
//  Created by Vanamali Dhurvaas on 7/2/22.
//

import AVFoundation
import UIKit

class BirdSoundsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource
{
...
//        let fileUrl = url.appendingPathComponent("updatingDateFolder").appendingPathComponent("birdDate.txt")
...
//        }
    ...
    {
        let cell = tableView.dequeueReusableCell(withIdentifier: "CellId3") as! UITableViewCell
