...
class FreqViewController: UIViewController, UITableViewDelegate, UITableViewDataSource
{
...
//        let fileUrl = url.appendingPathComponent("updatingDateFolder").appendingPathComponent("freqDate.txt")
...
//        }
    ...
    {
        let cell = tableView.dequeueReusableCell(withIdentifier: "CellId7") as! UITableViewCell
